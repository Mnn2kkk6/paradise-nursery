...
│ │ ├── AboutUs.jsx
│ │ ├── CartItem.jsx
│ │ ├── FloraChat.jsx # Flora chatbot widget
│ │ ├── Navbar.jsx # Shared navigation bar
│ │ ├── PlantDetail.jsx # Product detail page
│ │ └── ProductList.jsx # Department product grid
│ ├── data/
│ │ ├── plantsData.js # Product catalog, by department
│ │ └── floraKnowledge.js # Flora's rule-based knowledge base
│ ├── redux/
